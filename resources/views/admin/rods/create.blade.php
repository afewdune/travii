...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Add New Rod</div>

                <div class="card-body">
                    <form action="{{ route('admin.rods.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="chance_common" name="chance_common" required>
                        </div>
                        <div class="mb-3">
                            <label for="chance_rare" class="form-label">Chance Rare</label>
                            <input type="number" step="0.01" class="form-control" id="chance_rare" name="chance_rare" required>
                        </div>
                        <div class="mb-3">
                            <label for="chance_sr" class="form-label">Chance SR</label>
                            <input type="number" step="0.01" class="form-control" id="chance_sr" name="chance_sr" required>
                        </div>
                        <div class="mb-3">
                            <label for="chance_ssr" class="form-label">Chance SSR</label>
                            <input type="number" step="0.01" class="form-control" id="chance_ssr" name="chance_ssr" required>
                        </div>
                        <div class="mb-3">
                            <label for="chance_nft" class="form-label">Chance NFT</label>
                            <input type="number" step="0.01" class="form-control" id="chance_nft" name="chance_nft" required>
                        </div>
                        <div class="mb-3">
                            <label for="chance_special" class="form-label">Chance Special</label>
                            <input type="number" step="0.01" class="form-control" id="chance_special" name="chance_special" required>
                        </div>
                        <div class="mb-3">
